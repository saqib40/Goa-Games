  ...
  <section className="py-16 bg-sky-50">
    <div className="container mx-auto text-center px-4">
      ...
      <div className="flex justify-center space-x-4">
        ...
        <a href="https://t.me/sonari_rahul" target="_blank" rel="noopener noreferrer">
            <button className="px-6 py-3 font-semibold text-white bg-gray-700 rounded-lg hover:bg-gray-800 transition-colors duration-300 shadow-lg">
              Contact Your Mentor
            </button>
        </a>
      </div>
